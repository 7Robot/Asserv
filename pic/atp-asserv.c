...
// You should redefine this function
__attribute__((weak)) void OnAvanceUnPeuAuCasOu() {}

// You should redefine this function
__attribute__((weak)) void OnGobeletDeux() {}

// You should redefine this function
__attribute__((weak)) void OnGobeletUn() {}

// You should redefine this function
__attribute__((weak)) void OnMaison() {}
